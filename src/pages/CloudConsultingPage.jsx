            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
              ...
              >
                <p className="text-gray-500 text-xl font-light leading-relaxed">
                  At Revify, our AWS Cloud Consulting services help healthcare
                  organizations seamlessly migrate, architect, and optimize
                  their infrastructure for the modern digital era.
                </p>

                <p className="border-l-2 border-teal-500 pl-8 text-black font-medium text-xl font-light leading-relaxed">
                  Leveraging powerhouse AWS services like{" "}
                  <span className="font-bold">Amazon EC2</span> for scalable
                  computing, <span className="font-bold">Amazon S3</span> for
                  secure data lakes, and AWS Shield for DDoS protection, we
                  build HIPAA-compliant cloud environments that guarantee uptime
                  and strict security.
                </p>
                ...
                <div className="pt-8">
                  <div className="flex items-center gap-6 group cursor-default">
                    ...
                    <p className="text-xs font-black uppercase tracking-widest text-black">
                      Scalability • Security • Migration
                    </p>
                  </div>
                </div>
              </motion.div>
