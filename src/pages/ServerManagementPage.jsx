            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
              ...
              >
                <p className="text-gray-500 text-xl font-light leading-relaxed">
                  Our Server Management solutions take the heavy lifting out of
                  maintaining your AWS infrastructure, ensuring your systems are
                  always up-to-date, secure, and performing at their peak.
                </p>

                <p className="border-l-2 border-teal-500 pl-8 text-black font-medium text-xl font-light leading-relaxed">
                  We utilize{" "}
                  <span className="font-bold">Amazon CloudWatch</span> for 24/7
                  proactive monitoring,{" "}
                  <span className="font-bold">AWS Systems Manager</span> for
                  automated patching, and{" "}
                  <span className="font-bold">Amazon RDS</span> for fully
                  managed database performance. Your servers remain highly
                  available and cost-optimized, allowing your team to focus
                ...
                <div className="pt-8">
                  <div className="flex items-center gap-6 group cursor-default">
                    ...
                    <p className="text-xs font-black uppercase tracking-widest text-black">
                      Monitoring • Uptime • Optimization
                    </p>
                  </div>
                </div>
              </motion.div>
